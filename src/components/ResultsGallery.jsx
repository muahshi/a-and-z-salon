...
export default function ResultsGallery() {
  // Yahan aapki 6 real .png images ke paths set kiye gaye hain
  const images = [
    "/images/result1.png",
    "/images/result2.png",
    "/images/result3.png",
    ...
    <section id="results" className="py-24 bg-zinc-950 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mt-12">
          <a href="https://instagram.com/a_and_z_scissors" target="_blank" rel="noreferrer" className="inline-block border border-fuchsia-600 text-fuchsia-500 hover:bg-fuchsia-600 hover:text-white px-8 py-3 rounded-full text-xs font-bold tracking-widest uppercase transition-all duration-300">
            View More Results
          </a>
        </div>
      </div>
